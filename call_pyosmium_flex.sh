...
if ! osm2pgsql --append --slim -d gis -S /home/${local_filesystem_user}/src/openstreetmap-carto/openstreetmap-carto-flex.lua -C 2500 --number-processes 4 --expire-tiles=1-20 --expire-output=/var/cache/renderd/pyosmium/dirty_tiles.txt /var/cache/renderd/pyosmium/newchange.osc.gz > osm2pgsql.$$ 2>&1
then
    # ------------------------------------------------------------------------------
